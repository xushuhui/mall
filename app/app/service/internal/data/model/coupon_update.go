...
func (cu *CouponUpdate) AddCategoryIDs(ids ...int64) *CouponUpdate {
	cu.mutation.AddCategoryIDs(ids...)
	return cu
}

// AddCategory adds the "category" edges to the Category entity.
func (cu *CouponUpdate) AddCategory(c ...*Category) *CouponUpdate {
...
func (cu *CouponUpdate) AddActivityIDs(ids ...int64) *CouponUpdate {
	cu.mutation.AddActivityIDs(ids...)
	return cu
}

// AddActivity adds the "activity" edges to the Activity entity.
func (cu *CouponUpdate) AddActivity(a ...*Activity) *CouponUpdate {
...
func (cu *CouponUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := cu.mutation.RemovedCategoryIDs(); len(nodes) > 0 && !cu.mutation.CategoryCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   coupon.CategoryTable,
	...
	if nodes := cu.mutation.RemovedActivityIDs(); len(nodes) > 0 && !cu.mutation.ActivityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   coupon.ActivityTable,
...
// AddCategoryIDs adds the "category" edge to the Category entity by IDs.
func (cuo *CouponUpdateOne) AddCategoryIDs(ids ...int64) *CouponUpdateOne {
	cuo.mutation.AddCategoryIDs(ids...)
	return cuo
}

// AddCategory adds the "category" edges to the Category entity.
func (cuo *CouponUpdateOne) AddCategory(c ...*Category) *CouponUpdateOne {
	ids := make([]int64, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
...
// AddActivityIDs adds the "activity" edge to the Activity entity by IDs.
func (cuo *CouponUpdateOne) AddActivityIDs(ids ...int64) *CouponUpdateOne {
	cuo.mutation.AddActivityIDs(ids...)
	return cuo
}

// AddActivity adds the "activity" edges to the Activity entity.
func (cuo *CouponUpdateOne) AddActivity(a ...*Activity) *CouponUpdateOne {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
// ClearCategory clears all "category" edges to the Category entity.
func (cuo *CouponUpdateOne) ClearCategory() *CouponUpdateOne {
	cuo.mutation.ClearCategory()
	return cuo
}

// RemoveCategoryIDs removes the "category" edge to Category entities by IDs.
func (cuo *CouponUpdateOne) RemoveCategoryIDs(ids ...int64) *CouponUpdateOne {
	cuo.mutation.RemoveCategoryIDs(ids...)
	return cuo
}

// RemoveCategory removes "category" edges to Category entities.
func (cuo *CouponUpdateOne) RemoveCategory(c ...*Category) *CouponUpdateOne {
	ids := make([]int64, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
...
// ClearActivity clears all "activity" edges to the Activity entity.
func (cuo *CouponUpdateOne) ClearActivity() *CouponUpdateOne {
	cuo.mutation.ClearActivity()
	return cuo
}

// RemoveActivityIDs removes the "activity" edge to Activity entities by IDs.
func (cuo *CouponUpdateOne) RemoveActivityIDs(ids ...int64) *CouponUpdateOne {
	cuo.mutation.RemoveActivityIDs(ids...)
	return cuo
}

// RemoveActivity removes "activity" edges to Activity entities.
func (cuo *CouponUpdateOne) RemoveActivity(a ...*Activity) *CouponUpdateOne {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
func (cuo *CouponUpdateOne) sqlSave(ctx context.Context) (_node *Coupon, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "ID", err: fmt.Errorf("missing Coupon.ID for update")}
	}
	...
	if nodes := cuo.mutation.RemovedCategoryIDs(); len(nodes) > 0 && !cuo.mutation.CategoryCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   coupon.CategoryTable,
	...
	if nodes := cuo.mutation.RemovedActivityIDs(); len(nodes) > 0 && !cuo.mutation.ActivityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   coupon.ActivityTable,
