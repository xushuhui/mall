...
func (tq *ThemeQuery) QuerySpu() *SpuQuery {
...
func (tq *ThemeQuery) WithSpu(opts ...func(*SpuQuery)) *ThemeQuery {
	query := &SpuQuery{config: tq.config}
...
func (tq *ThemeQuery) sqlAll(ctx context.Context) ([]*Theme, error) {
	...
	if query := tq.withSpu; query != nil {
		...
		ids := make(map[int64]*Theme, len(nodes))
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(theme.SpuPrimaryKey[0], fks...))
			},
