...
// was not loaded in eager-loading.
func (e SpuEdges) ThemeOrErr() ([]*Theme, error) {
	if e.loadedTypes[5] {
		return e.Theme, nil
	}
...
// was not loaded in eager-loading.
func (e SpuEdges) ActivityOrErr() ([]*Activity, error) {
	if e.loadedTypes[6] {
...
// was not loaded in eager-loading.
func (e SpuEdges) BrandOrErr() ([]*Brand, error) {
	if e.loadedTypes[7] {
		return e.Brand, nil
	}
...
// QueryTheme queries the "theme" edge of the Spu entity.
func (s *Spu) QueryTheme() *ThemeQuery {
	return (&SpuClient{config: s.config}).QueryTheme(s)
}

// QueryActivity queries the "activity" edge of the Spu entity.
func (s *Spu) QueryActivity() *ActivityQuery {
	return (&SpuClient{config: s.config}).QueryActivity(s)
}

// QueryBrand queries the "brand" edge of the Spu entity.
func (s *Spu) QueryBrand() *BrandQuery {
	return (&SpuClient{config: s.config}).QueryBrand(s)
}
