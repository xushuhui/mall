...
func ID(id int64) predicate.Brand {
...
func IDEQ(id int64) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int64) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func IDIn(ids ...int64) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func IDNotIn(ids ...int64) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int64) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func IDGTE(id int64) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func IDLT(id int64) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func IDLTE(id int64) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func DeleteTime(v time.Time) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func DeleteTimeEQ(v time.Time) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldDeleteTime), v))
	})
}
...
func DeleteTimeNEQ(v time.Time) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func DeleteTimeIn(vs ...time.Time) predicate.Brand {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeleteTimeNotIn(vs ...time.Time) predicate.Brand {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeleteTimeGT(v time.Time) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func DeleteTimeGTE(v time.Time) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func DeleteTimeLT(v time.Time) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func DeleteTimeLTE(v time.Time) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func DeleteTimeIsNil() predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func DeleteTimeNotNil() predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
...
func HasSpuWith(preds ...predicate.Spu) predicate.Brand {
	return predicate.Brand(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
