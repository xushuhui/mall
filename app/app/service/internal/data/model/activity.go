...
func (e ActivityEdges) SpuOrErr() ([]*Spu, error) {
	if e.loadedTypes[0] {
		return e.Spu, nil
	}
...
// QuerySpu queries the "spu" edge of the Activity entity.
func (a *Activity) QuerySpu() *SpuQuery {
	return (&ActivityClient{config: a.config}).QuerySpu(a)
}
