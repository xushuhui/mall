...
func (au *ActivityUpdate) AddSpuIDs(ids ...int64) *ActivityUpdate {
	au.mutation.AddSpuIDs(ids...)
	return au
}

// AddSpu adds the "spu" edges to the Spu entity.
func (au *ActivityUpdate) AddSpu(s ...*Spu) *ActivityUpdate {
	ids := make([]int64, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return au.AddSpuIDs(ids...)
}
...
func (au *ActivityUpdate) ClearSpu() *ActivityUpdate {
	au.mutation.ClearSpu()
	return au
}

// RemoveSpuIDs removes the "spu" edge to Spu entities by IDs.
func (au *ActivityUpdate) RemoveSpuIDs(ids ...int64) *ActivityUpdate {
	au.mutation.RemoveSpuIDs(ids...)
	return au
}

// RemoveSpu removes "spu" edges to Spu entities.
func (au *ActivityUpdate) RemoveSpu(s ...*Spu) *ActivityUpdate {
	ids := make([]int64, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return au.RemoveSpuIDs(ids...)
}
...
func (au *ActivityUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := au.mutation.RemovedSpuIDs(); len(nodes) > 0 && !au.mutation.SpuCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   activity.SpuTable,
	...
	if nodes := au.mutation.SpuIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   activity.SpuTable,
...
// AddSpuIDs adds the "spu" edge to the Spu entity by IDs.
func (auo *ActivityUpdateOne) AddSpuIDs(ids ...int64) *ActivityUpdateOne {
	auo.mutation.AddSpuIDs(ids...)
	return auo
}

// AddSpu adds the "spu" edges to the Spu entity.
func (auo *ActivityUpdateOne) AddSpu(s ...*Spu) *ActivityUpdateOne {
	ids := make([]int64, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return auo.AddSpuIDs(ids...)
}
...
// ClearSpu clears all "spu" edges to the Spu entity.
func (auo *ActivityUpdateOne) ClearSpu() *ActivityUpdateOne {
	auo.mutation.ClearSpu()
	return auo
}

// RemoveSpuIDs removes the "spu" edge to Spu entities by IDs.
func (auo *ActivityUpdateOne) RemoveSpuIDs(ids ...int64) *ActivityUpdateOne {
	auo.mutation.RemoveSpuIDs(ids...)
	return auo
}

// RemoveSpu removes "spu" edges to Spu entities.
func (auo *ActivityUpdateOne) RemoveSpu(s ...*Spu) *ActivityUpdateOne {
	ids := make([]int64, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return auo.RemoveSpuIDs(ids...)
}
...
func (auo *ActivityUpdateOne) sqlSave(ctx context.Context) (_node *Activity, err error) {
	...
	if nodes := auo.mutation.RemovedSpuIDs(); len(nodes) > 0 && !auo.mutation.SpuCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   activity.SpuTable,
	...
	if nodes := auo.mutation.SpuIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   activity.SpuTable,
