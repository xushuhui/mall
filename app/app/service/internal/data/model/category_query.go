...
func (cgb *CategoryGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("model: CategoryGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoryGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("model: CategoryGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoryGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("model: CategoryGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoryGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("model: CategoryGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoryGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("model: CategoryGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoryGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("model: CategoryGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoryGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("model: CategoryGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoryGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("model: CategoryGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategorySelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("model: CategorySelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategorySelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("model: CategorySelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategorySelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("model: CategorySelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategorySelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("model: CategorySelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategorySelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("model: CategorySelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategorySelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("model: CategorySelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategorySelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("model: CategorySelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategorySelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{category.Label}
	default:
		err = fmt.Errorf("model: CategorySelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
