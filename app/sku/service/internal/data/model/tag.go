...
func (e TagEdges) SpuOrErr() ([]*Spu, error) {
	if e.loadedTypes[0] {
		return e.Spu, nil
	}
...
// QuerySpu queries the "spu" edge of the Tag entity.
func (t *Tag) QuerySpu() *SpuQuery {
	return (&TagClient{config: t.config}).QuerySpu(t)
}
