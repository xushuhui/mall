...
func (oq *OrderQuery) QueryOrderSnap() *OrderSnapQuery {
	query := &OrderSnapQuery{config: oq.config}
...
// QueryOrderSub chains the current query on the "order_sub" edge.
func (oq *OrderQuery) QueryOrderSub() *OrderSubQuery {
	query := &OrderSubQuery{config: oq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := oq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// Last returns the last Order entity from the query.
// Returns a *NotFoundError when no Order was found.
func (oq *OrderQuery) Last(ctx context.Context) (*Order, error) {
...
func (oq *OrderQuery) LastX(ctx context.Context) *Order {
	node, err := oq.Last(ctx)
	if err != nil && !IsNotFound(err) {
		panic(err)
	}
	return node
...
// LastID returns the last Order ID from the query.
// Returns a *NotFoundError when no Order ID was found.
func (oq *OrderQuery) LastID(ctx context.Context) (id int64, err error) {
	var ids []int64
	if ids, err = oq.IDs(ctx); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{order.Label}
...
func (oq *OrderQuery) LastIDX(ctx context.Context) int64 {
	id, err := oq.LastID(ctx)
	if err != nil && !IsNotFound(err) {
		panic(err)
	}
	return id
...
// the "order_snap" edge. The optional arguments are used to configure the query builder of the edge.
func (oq *OrderQuery) WithOrderSnap(opts ...func(*OrderSnapQuery)) *OrderQuery {
	query := &OrderSnapQuery{config: oq.config}
	for _, opt := range opts {
		opt(query)
	}
	oq.withOrderSnap = query
	return oq
}

// WithOrderSub tells the query-builder to eager-load the nodes that are connected to
// the "order_sub" edge. The optional arguments are used to configure the query builder of the edge.
func (oq *OrderQuery) WithOrderSub(opts ...func(*OrderSubQuery)) *OrderQuery {
	query := &OrderSubQuery{config: oq.config}
	for _, opt := range opts {
		opt(query)
	}
	oq.withOrderSub = query
	return oq
}
...
func (oq *OrderQuery) sqlAll(ctx context.Context) ([]*Order, error) {
	...
	if query := oq.withOrderSnap; query != nil {
		...
		for i := range nodes {
			...
			nodes[i].Edges.OrderSnap = []*OrderSnap{}
		}
		query.Where(predicate.OrderSnap(func(s *sql.Selector) {
			s.Where(sql.InValues(order.OrderSnapColumn, fks...))
		}))
		...
		for _, n := range neighbors {
			...
			node.Edges.OrderSnap = append(node.Edges.OrderSnap, n)
		}
	}

	if query := oq.withOrderSub; query != nil {
		fks := make([]driver.Value, 0, len(nodes))
		nodeids := make(map[int64]*Order)
		for i := range nodes {
			fks = append(fks, nodes[i].ID)
			nodeids[nodes[i].ID] = nodes[i]
			nodes[i].Edges.OrderSub = []*OrderSub{}
		}
		query.Where(predicate.OrderSub(func(s *sql.Selector) {
			s.Where(sql.InValues(order.OrderSubColumn, fks...))
		}))
		neighbors, err := query.All(ctx)
		if err != nil {
			return nil, err
		...
		for _, n := range neighbors {
			...
			node.Edges.OrderSub = append(node.Edges.OrderSub, n)
		}
	}
...
func (ogb *OrderGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ogb.fields) > 1 {
		return nil, errors.New("model: OrderGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ogb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ogb *OrderGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{order.Label}
	default:
		err = fmt.Errorf("model: OrderGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ogb *OrderGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ogb.fields) > 1 {
		return nil, errors.New("model: OrderGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ogb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ogb *OrderGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{order.Label}
	default:
		err = fmt.Errorf("model: OrderGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ogb *OrderGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ogb.fields) > 1 {
		return nil, errors.New("model: OrderGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ogb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ogb *OrderGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{order.Label}
	default:
		err = fmt.Errorf("model: OrderGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ogb *OrderGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ogb.fields) > 1 {
		return nil, errors.New("model: OrderGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ogb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ogb *OrderGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{order.Label}
	default:
		err = fmt.Errorf("model: OrderGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (os *OrderSelect) Strings(ctx context.Context) ([]string, error) {
	if len(os.fields) > 1 {
		return nil, errors.New("model: OrderSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := os.Scan(ctx, &v); err != nil {
		return nil, err
...
func (os *OrderSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{order.Label}
	default:
		err = fmt.Errorf("model: OrderSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (os *OrderSelect) Ints(ctx context.Context) ([]int, error) {
	if len(os.fields) > 1 {
		return nil, errors.New("model: OrderSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := os.Scan(ctx, &v); err != nil {
		return nil, err
...
func (os *OrderSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{order.Label}
	default:
		err = fmt.Errorf("model: OrderSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (os *OrderSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(os.fields) > 1 {
		return nil, errors.New("model: OrderSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := os.Scan(ctx, &v); err != nil {
		return nil, err
...
func (os *OrderSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{order.Label}
	default:
		err = fmt.Errorf("model: OrderSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (os *OrderSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(os.fields) > 1 {
		return nil, errors.New("model: OrderSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := os.Scan(ctx, &v); err != nil {
		return nil, err
...
func (os *OrderSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{order.Label}
	default:
		err = fmt.Errorf("model: OrderSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
