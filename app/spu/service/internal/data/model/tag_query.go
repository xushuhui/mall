...
func (tq *TagQuery) QuerySpu() *SpuQuery {
	query := &SpuQuery{config: tq.config}
...
// Last returns the last Tag entity from the query.
// Returns a *NotFoundError when no Tag was found.
func (tq *TagQuery) Last(ctx context.Context) (*Tag, error) {
...
func (tq *TagQuery) LastX(ctx context.Context) *Tag {
...
// LastID returns the last Tag ID from the query.
// Returns a *NotFoundError when no Tag ID was found.
func (tq *TagQuery) LastID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (tq *TagQuery) LastIDX(ctx context.Context) int64 {
...
func (tq *TagQuery) WithSpu(opts ...func(*SpuQuery)) *TagQuery {
	query := &SpuQuery{config: tq.config}
	...
	if query := tq.withSpu; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(tag.SpuPrimaryKey[1], fks...))
			},
...
func (tgb *TagGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("model: TagGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TagGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{tag.Label}
	default:
		err = fmt.Errorf("model: TagGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TagGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("model: TagGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TagGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{tag.Label}
	default:
		err = fmt.Errorf("model: TagGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TagGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("model: TagGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TagGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{tag.Label}
	default:
		err = fmt.Errorf("model: TagGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TagGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("model: TagGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TagGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{tag.Label}
	default:
		err = fmt.Errorf("model: TagGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TagSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("model: TagSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TagSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{tag.Label}
	default:
		err = fmt.Errorf("model: TagSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TagSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("model: TagSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TagSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{tag.Label}
	default:
		err = fmt.Errorf("model: TagSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TagSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("model: TagSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TagSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{tag.Label}
	default:
		err = fmt.Errorf("model: TagSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TagSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("model: TagSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TagSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{tag.Label}
	default:
		err = fmt.Errorf("model: TagSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
