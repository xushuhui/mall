...
func (uic *UserInfoCreate) check() error {
	if _, ok := uic.mutation.CreateTime(); !ok {
		return &ValidationError{Name: "create_time", err: errors.New(`model: missing required field "UserInfo.create_time"`)}
	}
	if _, ok := uic.mutation.UpdateTime(); !ok {
		return &ValidationError{Name: "update_time", err: errors.New(`model: missing required field "UserInfo.update_time"`)}
	}
	if _, ok := uic.mutation.Nickname(); !ok {
		return &ValidationError{Name: "nickname", err: errors.New(`model: missing required field "UserInfo.nickname"`)}
	}
	if _, ok := uic.mutation.Phone(); !ok {
		return &ValidationError{Name: "phone", err: errors.New(`model: missing required field "UserInfo.phone"`)}
	}
	if _, ok := uic.mutation.Avatar(); !ok {
		return &ValidationError{Name: "avatar", err: errors.New(`model: missing required field "UserInfo.avatar"`)}
	}
	if _, ok := uic.mutation.WxProfile(); !ok {
		return &ValidationError{Name: "wx_profile", err: errors.New(`model: missing required field "UserInfo.wx_profile"`)}
	}
	return nil
}
