...
func (uwdc *UserWalletDetailCreate) check() error {
	if _, ok := uwdc.mutation.CreateTime(); !ok {
		return &ValidationError{Name: "create_time", err: errors.New(`model: missing required field "UserWalletDetail.create_time"`)}
	}
	if _, ok := uwdc.mutation.UpdateTime(); !ok {
		return &ValidationError{Name: "update_time", err: errors.New(`model: missing required field "UserWalletDetail.update_time"`)}
	}
	if _, ok := uwdc.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`model: missing required field "UserWalletDetail.description"`)}
	}
	if _, ok := uwdc.mutation.GetOp(); !ok {
		return &ValidationError{Name: "op", err: errors.New(`model: missing required field "UserWalletDetail.op"`)}
	}
	if _, ok := uwdc.mutation.Current(); !ok {
		return &ValidationError{Name: "current", err: errors.New(`model: missing required field "UserWalletDetail.current"`)}
	}
	if _, ok := uwdc.mutation.Value(); !ok {
		return &ValidationError{Name: "value", err: errors.New(`model: missing required field "UserWalletDetail.value"`)}
	}
	if _, ok := uwdc.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`model: missing required field "UserWalletDetail.type"`)}
	}
	return nil
}
