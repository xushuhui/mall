...
var file_app_user_service_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1a, 0x75, 0x73, 0x65,
	...
	0x74, 0x72, 0x61, 0x70, 0x12, 0x3a, 0x0a, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xd8, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65,
	...
	0x74, 0x22, 0xfd, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x45, 0x0a, 0x08, 0x64, 0x61,
	...
	0x74, 0x22, 0x8b, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x12, 0x43,
	0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x69, 0x6e,
	...
	0x2c, 0x5a, 0x2a, 0x6d, 0x61, 0x6c, 0x6c, 0x2d, 0x67, 0x6f, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x61,
	0x70, 0x70, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72,
...
var file_app_user_service_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Registry)(nil),            // 3: user.service.internal.conf.Registry
	...
	(*Registry_Consul)(nil),     // 8: user.service.internal.conf.Registry.Consul
...
var file_app_user_service_internal_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 2: user.service.internal.conf.Server.http:type_name -> user.service.internal.conf.Server.HTTP
	5,  // 3: user.service.internal.conf.Server.grpc:type_name -> user.service.internal.conf.Server.GRPC
	6,  // 4: user.service.internal.conf.Data.database:type_name -> user.service.internal.conf.Data.Database
	7,  // 5: user.service.internal.conf.Data.redis:type_name -> user.service.internal.conf.Data.Redis
	8,  // 6: user.service.internal.conf.Registry.consul:type_name -> user.service.internal.conf.Registry.Consul
	9,  // 7: user.service.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	9,  // 8: user.service.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	9,  // 9: user.service.internal.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	9,  // 10: user.service.internal.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
...
func file_app_user_service_internal_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_app_user_service_internal_conf_conf_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_app_user_service_internal_conf_conf_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
