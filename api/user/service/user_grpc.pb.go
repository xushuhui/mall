...
type UserClient interface {
	...
	ListUser(ctx context.Context, in *IdsRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *userClient) ListUser(ctx context.Context, in *IdsRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type UserServer interface {
	...
	ListUser(context.Context, *IdsRequest) (*empty.Empty, error)
...
func (UnimplementedUserServer) ListUser(context.Context, *IdsRequest) (*empty.Empty, error) {
