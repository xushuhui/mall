...
type UserHTTPClient interface {
	...
	ListUser(ctx context.Context, req *IdsRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
}
...
func (c *UserHTTPClientImpl) ListUser(ctx context.Context, in *IdsRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/user"
	path := binding.EncodeURL(pattern, in, true)
