...
func RegisterInterfaceHTTPServer(s *http.Server, srv InterfaceHTTPServer) {
	r := s.Route("/")
	r.GET("/banner/id/{id}", _Interface_GetBannerById2_HTTP_Handler(srv))
...
func _Interface_GetBannerById2_HTTP_Handler(srv InterfaceHTTPServer) func(ctx http.Context) error {
...
func _Interface_GetAllCategory0_HTTP_Handler(srv InterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetAllCategory(ctx, req.(*empty.Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _Interface_GetGridCategory0_HTTP_Handler(srv InterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetGridCategory(ctx, req.(*empty.Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _Interface_GetWholeCoupon0_HTTP_Handler(srv InterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetWholeCoupon(ctx, req.(*empty.Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _Interface_GetMyAvailableCoupon0_HTTP_Handler(srv InterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetMyAvailableCoupon(ctx, req.(*empty.Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _Interface_GetSaleExplain0_HTTP_Handler(srv InterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetSaleExplain(ctx, req.(*empty.Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _Interface_GetSpuLatest0_HTTP_Handler(srv InterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetSpuLatest(ctx, req.(*empty.Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type InterfaceHTTPClient interface {
	Charge(ctx context.Context, req *ChargeRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
	CollectCoupon(ctx context.Context, req *CollectCouponRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
	CreateAddress(ctx context.Context, req *CreateAddressRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
	DeleteAddress(ctx context.Context, req *DeleteAddressRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
	...
	GetAddress(ctx context.Context, req *GetAddressRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
	GetAllCategory(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *AllCategory, err error)
	...
	GetGridCategory(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *GridCategories, err error)
	GetMyAvailableCoupon(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *Coupons, err error)
	GetMyCouponByStatus(ctx context.Context, req *MyCouponByStatusRequest, opts ...http.CallOption) (rsp *Coupons, err error)
	GetSaleExplain(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *SaleExplains, err error)
	...
	GetSpuLatest(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *SpuPage, err error)
	...
	GetWholeCoupon(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *Coupons, err error)
	ListAddress(ctx context.Context, req *CreateAddressRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
	...
	SetDefaultAddr(ctx context.Context, req *SetDefaultAddrRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
	UpdateInfo(ctx context.Context, req *UpdateInfoRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
...
func (c *InterfaceHTTPClientImpl) Charge(ctx context.Context, in *ChargeRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/charge"
...
func (c *InterfaceHTTPClientImpl) CollectCoupon(ctx context.Context, in *CollectCouponRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
...
func (c *InterfaceHTTPClientImpl) CreateAddress(ctx context.Context, in *CreateAddressRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/address"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *InterfaceHTTPClientImpl) DeleteAddress(ctx context.Context, in *DeleteAddressRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/address/{id}"
...
func (c *InterfaceHTTPClientImpl) GetAddress(ctx context.Context, in *GetAddressRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/address/{id}"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *InterfaceHTTPClientImpl) GetAllCategory(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*AllCategory, error) {
	var out AllCategory
...
func (c *InterfaceHTTPClientImpl) GetGridCategory(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*GridCategories, error) {
...
func (c *InterfaceHTTPClientImpl) GetMyAvailableCoupon(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*Coupons, error) {
	var out Coupons
...
func (c *InterfaceHTTPClientImpl) GetSaleExplain(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*SaleExplains, error) {
...
func (c *InterfaceHTTPClientImpl) GetSpuLatest(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*SpuPage, error) {
	var out SpuPage
	pattern := "/spu/latest"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *InterfaceHTTPClientImpl) GetWholeCoupon(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*Coupons, error) {
	var out Coupons
...
func (c *InterfaceHTTPClientImpl) ListAddress(ctx context.Context, in *CreateAddressRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/addresses"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *InterfaceHTTPClientImpl) SetDefaultAddr(ctx context.Context, in *SetDefaultAddrRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
...
func (c *InterfaceHTTPClientImpl) UpdateInfo(ctx context.Context, in *UpdateInfoRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/info"
	path := binding.EncodeURL(pattern, in, false)
