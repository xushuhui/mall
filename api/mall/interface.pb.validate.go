...
// Validate checks the field values on MiniappLoginRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MiniappLoginRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MiniappLoginRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MiniappLoginRequestMultiError, or nil if none found.
func (m *MiniappLoginRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *MiniappLoginRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// MiniappLoginRequestMultiError is an error wrapping multiple validation
// errors returned by MiniappLoginRequest.ValidateAll() if the designated
// constraints aren't met.
type MiniappLoginRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MiniappLoginRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MiniappLoginRequestMultiError) AllErrors() []error { return m }

// MiniappLoginRequestValidationError is the validation error returned by
// MiniappLoginRequest.Validate if the designated constraints aren't met.
type MiniappLoginRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MiniappLoginRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MiniappLoginRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MiniappLoginRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MiniappLoginRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MiniappLoginRequestValidationError) ErrorName() string {
	return "MiniappLoginRequestValidationError"
}

// Error satisfies the builtin error interface
func (e MiniappLoginRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMiniappLoginRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MiniappLoginRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MiniappLoginRequestValidationError{}
