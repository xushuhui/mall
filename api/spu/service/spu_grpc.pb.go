...
func (c *spuClient) GetSaleExplain(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*SaleExplains, error) {
...
func (c *spuClient) GetSpuLatest(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*SpuPage, error) {
	out := new(SpuPage)
...
func (UnimplementedSpuServer) GetSaleExplain(context.Context, *empty.Empty) (*SaleExplains, error) {
...
func (UnimplementedSpuServer) GetSpuLatest(context.Context, *empty.Empty) (*SpuPage, error) {
...
func _Spu_GetSaleExplain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpuServer).GetSaleExplain(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Spu_GetSpuLatest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpuServer).GetSpuLatest(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
