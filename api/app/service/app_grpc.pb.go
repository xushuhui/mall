...
type AppClient interface {
	...
	ListCategory(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Categories, error)
	ListGridCategory(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GridCategories, error)
...
func (c *appClient) ListCategory(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Categories, error) {
	out := new(Categories)
...
func (c *appClient) ListGridCategory(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GridCategories, error) {
...
func (UnimplementedAppServer) ListCategory(context.Context, *empty.Empty) (*Categories, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListCategory not implemented")
}
func (UnimplementedAppServer) ListGridCategory(context.Context, *empty.Empty) (*GridCategories, error) {
...
func _App_ListCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServer).ListCategory(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _App_ListGridCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServer).ListGridCategory(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
