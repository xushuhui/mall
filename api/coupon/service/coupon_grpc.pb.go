...
type CouponClient interface {
	...
	CreateUserCoupon(ctx context.Context, in *CreateUserCouponRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *couponClient) CreateUserCoupon(ctx context.Context, in *CreateUserCouponRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type CouponServer interface {
	...
	CreateUserCoupon(context.Context, *CreateUserCouponRequest) (*empty.Empty, error)
...
func (UnimplementedCouponServer) CreateUserCoupon(context.Context, *CreateUserCouponRequest) (*empty.Empty, error) {
