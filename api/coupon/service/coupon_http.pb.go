...
type CouponHTTPClient interface {
	CreateUserCoupon(ctx context.Context, req *CreateUserCouponRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
...
func (c *CouponHTTPClientImpl) CreateUserCoupon(ctx context.Context, in *CreateUserCouponRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/coupon/user"
