...
var ProviderSet = wire.NewSet(NewData, NewEntClient,NewRedisClient, NewBannerRepo, NewActivityRepo, NewCouponRepo,
...
// NewData .
func NewData(entClient *model.Client,rdb *redis.Client, logger log.Logger) (*Data, func(), error) {
	cleanup := func() {
