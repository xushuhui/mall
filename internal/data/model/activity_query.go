...
func (aq *ActivityQuery) QuerySpu() *SpuQuery {
	query := &SpuQuery{config: aq.config}
...
func (aq *ActivityQuery) WithSpu(opts ...func(*SpuQuery)) *ActivityQuery {
	query := &SpuQuery{config: aq.config}
	...
	if query := aq.withSpu; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			Edge: &sqlgraph.EdgeSpec{
				Inverse: false,
				Table:   activity.SpuTable,
				Columns: activity.SpuPrimaryKey,
			},
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(activity.SpuPrimaryKey[0], fks...))
			},
...
func (agb *ActivityGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("model: ActivityGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *ActivityGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{activity.Label}
	default:
		err = fmt.Errorf("model: ActivityGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *ActivityGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("model: ActivityGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *ActivityGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{activity.Label}
	default:
		err = fmt.Errorf("model: ActivityGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *ActivityGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("model: ActivityGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *ActivityGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{activity.Label}
	default:
		err = fmt.Errorf("model: ActivityGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *ActivityGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("model: ActivityGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *ActivityGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{activity.Label}
	default:
		err = fmt.Errorf("model: ActivityGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *ActivitySelect) Strings(ctx context.Context) ([]string, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("model: ActivitySelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *ActivitySelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{activity.Label}
	default:
		err = fmt.Errorf("model: ActivitySelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *ActivitySelect) Ints(ctx context.Context) ([]int, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("model: ActivitySelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *ActivitySelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{activity.Label}
	default:
		err = fmt.Errorf("model: ActivitySelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *ActivitySelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("model: ActivitySelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *ActivitySelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{activity.Label}
	default:
		err = fmt.Errorf("model: ActivitySelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *ActivitySelect) Bools(ctx context.Context) ([]bool, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("model: ActivitySelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *ActivitySelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{activity.Label}
	default:
		err = fmt.Errorf("model: ActivitySelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
