...
func (su *SpuUpdate) AddThemeIDs(ids ...int64) *SpuUpdate {
	su.mutation.AddThemeIDs(ids...)
	return su
}

// AddTheme adds the "theme" edges to the Theme entity.
func (su *SpuUpdate) AddTheme(t ...*Theme) *SpuUpdate {
	ids := make([]int64, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
func (su *SpuUpdate) AddActivityIDs(ids ...int64) *SpuUpdate {
	su.mutation.AddActivityIDs(ids...)
	return su
}

// AddActivity adds the "activity" edges to the Activity entity.
func (su *SpuUpdate) AddActivity(a ...*Activity) *SpuUpdate {
...
func (su *SpuUpdate) AddBrandIDs(ids ...int64) *SpuUpdate {
	su.mutation.AddBrandIDs(ids...)
	return su
}

// AddBrand adds the "brand" edges to the Brand entity.
func (su *SpuUpdate) AddBrand(b ...*Brand) *SpuUpdate {
	ids := make([]int64, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return su.AddBrandIDs(ids...)
}
...
// ClearTheme clears all "theme" edges to the Theme entity.
func (su *SpuUpdate) ClearTheme() *SpuUpdate {
	su.mutation.ClearTheme()
	return su
}

// RemoveThemeIDs removes the "theme" edge to Theme entities by IDs.
func (su *SpuUpdate) RemoveThemeIDs(ids ...int64) *SpuUpdate {
	su.mutation.RemoveThemeIDs(ids...)
	return su
}

// RemoveTheme removes "theme" edges to Theme entities.
func (su *SpuUpdate) RemoveTheme(t ...*Theme) *SpuUpdate {
	ids := make([]int64, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
func (su *SpuUpdate) ClearBrand() *SpuUpdate {
	su.mutation.ClearBrand()
	return su
}

// RemoveBrandIDs removes the "brand" edge to Brand entities by IDs.
func (su *SpuUpdate) RemoveBrandIDs(ids ...int64) *SpuUpdate {
	su.mutation.RemoveBrandIDs(ids...)
	return su
}

// RemoveBrand removes "brand" edges to Brand entities.
func (su *SpuUpdate) RemoveBrand(b ...*Brand) *SpuUpdate {
	ids := make([]int64, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return su.RemoveBrandIDs(ids...)
}
...
func (su *SpuUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := su.mutation.RemovedThemeIDs(); len(nodes) > 0 && !su.mutation.ThemeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   spu.ThemeTable,
	...
	if nodes := su.mutation.ThemeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   spu.ThemeTable,
	...
	if nodes := su.mutation.RemovedActivityIDs(); len(nodes) > 0 && !su.mutation.ActivityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   spu.ActivityTable,
	...
	if nodes := su.mutation.RemovedBrandIDs(); len(nodes) > 0 && !su.mutation.BrandCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   spu.BrandTable,
...
// AddThemeIDs adds the "theme" edge to the Theme entity by IDs.
func (suo *SpuUpdateOne) AddThemeIDs(ids ...int64) *SpuUpdateOne {
	suo.mutation.AddThemeIDs(ids...)
	return suo
}

// AddTheme adds the "theme" edges to the Theme entity.
func (suo *SpuUpdateOne) AddTheme(t ...*Theme) *SpuUpdateOne {
	ids := make([]int64, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// AddActivityIDs adds the "activity" edge to the Activity entity by IDs.
func (suo *SpuUpdateOne) AddActivityIDs(ids ...int64) *SpuUpdateOne {
	suo.mutation.AddActivityIDs(ids...)
	return suo
}

// AddActivity adds the "activity" edges to the Activity entity.
func (suo *SpuUpdateOne) AddActivity(a ...*Activity) *SpuUpdateOne {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
// AddBrandIDs adds the "brand" edge to the Brand entity by IDs.
func (suo *SpuUpdateOne) AddBrandIDs(ids ...int64) *SpuUpdateOne {
	suo.mutation.AddBrandIDs(ids...)
	return suo
}

// AddBrand adds the "brand" edges to the Brand entity.
func (suo *SpuUpdateOne) AddBrand(b ...*Brand) *SpuUpdateOne {
	ids := make([]int64, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return suo.AddBrandIDs(ids...)
}
...
// ClearTheme clears all "theme" edges to the Theme entity.
func (suo *SpuUpdateOne) ClearTheme() *SpuUpdateOne {
	suo.mutation.ClearTheme()
	return suo
}

// RemoveThemeIDs removes the "theme" edge to Theme entities by IDs.
func (suo *SpuUpdateOne) RemoveThemeIDs(ids ...int64) *SpuUpdateOne {
	suo.mutation.RemoveThemeIDs(ids...)
	return suo
}

// RemoveTheme removes "theme" edges to Theme entities.
func (suo *SpuUpdateOne) RemoveTheme(t ...*Theme) *SpuUpdateOne {
	ids := make([]int64, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// ClearActivity clears all "activity" edges to the Activity entity.
func (suo *SpuUpdateOne) ClearActivity() *SpuUpdateOne {
	suo.mutation.ClearActivity()
	return suo
}

// RemoveActivityIDs removes the "activity" edge to Activity entities by IDs.
func (suo *SpuUpdateOne) RemoveActivityIDs(ids ...int64) *SpuUpdateOne {
	suo.mutation.RemoveActivityIDs(ids...)
	return suo
}

// RemoveActivity removes "activity" edges to Activity entities.
func (suo *SpuUpdateOne) RemoveActivity(a ...*Activity) *SpuUpdateOne {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
// ClearBrand clears all "brand" edges to the Brand entity.
func (suo *SpuUpdateOne) ClearBrand() *SpuUpdateOne {
	suo.mutation.ClearBrand()
	return suo
}

// RemoveBrandIDs removes the "brand" edge to Brand entities by IDs.
func (suo *SpuUpdateOne) RemoveBrandIDs(ids ...int64) *SpuUpdateOne {
	suo.mutation.RemoveBrandIDs(ids...)
	return suo
}

// RemoveBrand removes "brand" edges to Brand entities.
func (suo *SpuUpdateOne) RemoveBrand(b ...*Brand) *SpuUpdateOne {
	ids := make([]int64, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return suo.RemoveBrandIDs(ids...)
}
...
func (suo *SpuUpdateOne) sqlSave(ctx context.Context) (_node *Spu, err error) {
	...
	if nodes := suo.mutation.RemovedThemeIDs(); len(nodes) > 0 && !suo.mutation.ThemeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   spu.ThemeTable,
	...
	if nodes := suo.mutation.ThemeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   spu.ThemeTable,
	...
	if nodes := suo.mutation.RemovedActivityIDs(); len(nodes) > 0 && !suo.mutation.ActivityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   spu.ActivityTable,
	...
	if nodes := suo.mutation.RemovedBrandIDs(); len(nodes) > 0 && !suo.mutation.BrandCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   spu.BrandTable,
