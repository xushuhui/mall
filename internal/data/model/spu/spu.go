...
var (
	...
	// ThemePrimaryKey and ThemeColumn2 are the table columns denoting the
	// primary key for the theme relation (M2M).
	ThemePrimaryKey = []string{"theme_id", "spu_id"}
	// ActivityPrimaryKey and ActivityColumn2 are the table columns denoting the
	// primary key for the activity relation (M2M).
	ActivityPrimaryKey = []string{"activity_id", "spu_id"}
	// BrandPrimaryKey and BrandColumn2 are the table columns denoting the
	// primary key for the brand relation (M2M).
	BrandPrimaryKey = []string{"brand_id", "spu_id"}
)
