...
func (e CouponEdges) CategoryOrErr() ([]*Category, error) {
	if e.loadedTypes[0] {
...
// was not loaded in eager-loading.
func (e CouponEdges) ActivityOrErr() ([]*Activity, error) {
	if e.loadedTypes[1] {
...
// QueryCategory queries the "category" edge of the Coupon entity.
func (c *Coupon) QueryCategory() *CategoryQuery {
	return (&CouponClient{config: c.config}).QueryCategory(c)
}
