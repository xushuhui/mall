...
import (
	...
	"mall-go/module/app/service/internal/data/model"
...
var ProviderSet = wire.NewSet(NewData, NewEntClient, NewBannerRepo, NewActivityRepo,
	NewThemeRepo, NewCategoryRepo)
