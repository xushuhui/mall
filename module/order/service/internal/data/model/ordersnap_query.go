...
func (osq *OrderSnapQuery) GroupBy(field string, fields ...string) *OrderSnapGroupBy {
	grbuild := &OrderSnapGroupBy{config: osq.config}
...
func (osq *OrderSnapQuery) Select(fields ...string) *OrderSnapSelect {
	...
	selbuild := &OrderSnapSelect{OrderSnapQuery: osq}
	selbuild.label = ordersnap.Label
...
func (osq *OrderSnapQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OrderSnap, error) {
	var (
		nodes       = []*OrderSnap{}
		_spec       = osq.querySpec()
		loadedTypes = [1]bool{
	...
	_spec.ScanValues = func(columns []string) ([]interface{}, error) {
		return (*OrderSnap).scanValues(nil, columns)
	}
